...
var paths = {
    ...
    src: {
        ...
        html:       'templates/**/*.html',
        css:        'templates/assets/css/*.css',
        js:         'templates/assets/js/*.js',
        vendors:    'templates/assets/vendors/**/*.*',
        imgs:       'templates/assets/imgs/**/*.+(png|jpg|gif|svg)',
        scss:       'templates/assets/scss/**/*.scss'
    },
    dist: {
        root:       'templates/dist',
        css:        'templates/dist/css',
        js:         'templates/dist/js',
        imgs:       'templates/dist/imgs',
        vendors:    'templates/dist/vendors'
    }
}
